...
class Tutorial(EnvExperiment):
	...
	def prepare(self):
		self.phase = [0.25, 0.25, 0.0, 0.0, 0.75, 0.75, 0.0, 0.0, 0.5, 0.5, 0.0, 0.0] # phase values in units of turns[2Pi rads]
		self.amp = [0.67,0.33,1.0, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1] # amplitude values 0-1.0 fraction of max voltage
	...
	def configure_ram_mode(self, dds):
		...
		dds.set(frequency=5*MHz, ram_destination=3)#emit a 5MHz rf signal using the RAM values at the given ram_destination 2 is ASF[amplitude modulation], 0 is FTW[frequency tuning modulation], 1 is POW[phase offset], 3is POWASF[combined phase and amplitude modulation?]
